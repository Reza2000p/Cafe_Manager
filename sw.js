...
// ==========================================
const CACHE_NAME = 'cafe-v8';

const STATIC_ASSETS = [
    './',
    './index.html?v=20260807_v1',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
    './css/styles.css?v=20260807_v1',
    './js/config.js?v=20260807_v1',
    './js/timers.js?v=20260807_v1',
    './js/app.js?v=20260807_v1'
];
