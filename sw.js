...
// ==========================================
const CACHE_NAME = 'cafe-v24';

const STATIC_ASSETS = [
    './',
    './index.html?v=20260809_v9',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
    './css/styles.css?v=20260809_v9',
    './js/config.js?v=20260809_v9',
    './js/timers.js?v=20260809_v9',
    './js/app.js?v=20260809_v9'
];
