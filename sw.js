...
// ==========================================
const CACHE_NAME = 'cafe-v14';

const STATIC_ASSETS = [
    './',
    './index.html?v=20260808_v6',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
    './css/styles.css?v=20260808_v6',
    './js/config.js?v=20260808_v6',
    './js/timers.js?v=20260808_v6',
    './js/app.js?v=20260808_v6'
];
