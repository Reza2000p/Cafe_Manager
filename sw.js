...
// ==========================================
const CACHE_NAME = 'cafe-v25';

const STATIC_ASSETS = [
    './',
    './index.html?v=20260809_v10',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
    './css/styles.css?v=20260809_v10',
    './js/config.js?v=20260809_v10',
    './js/timers.js?v=20260809_v10',
    './js/app.js?v=20260809_v10'
];
