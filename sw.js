...
// ==========================================
const CACHE_NAME = 'cafe-v12';

const STATIC_ASSETS = [
    './',
    './index.html?v=20260808_v4',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
    './css/styles.css?v=20260808_v4',
    './js/config.js?v=20260808_v4',
    './js/timers.js?v=20260808_v4',
    './js/app.js?v=20260808_v4'
];
