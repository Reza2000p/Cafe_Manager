...
// ==========================================
const CACHE_NAME = 'cafe-v15';

const STATIC_ASSETS = [
    './',
    './index.html?v=20260808_v7',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
    './css/styles.css?v=20260808_v7',
    './js/config.js?v=20260808_v7',
    './js/timers.js?v=20260808_v7',
    './js/app.js?v=20260808_v7'
];
